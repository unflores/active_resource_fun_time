...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { currency: @price.currency, location_id: @price.location_id, maximum: @price.maximum, minimum: @price.minimum }
    end
  ...
  test "should update price" do
    put :update, id: @price, price: { currency: @price.currency, location_id: @price.location_id, maximum: @price.maximum, minimum: @price.minimum }
    assert_redirected_to price_path(assigns(:price))
  end
